...
if (get_fit_amp_logo()) {
  ...
  $amp_image = wp_get_attachment_image_src( $amp_image_id, 'large' );
...
if (get_fit_image_logo()) {
  ...
  $logo_image = wp_get_attachment_image_src( $logo_image_id, 'large' );
...
<div class="singleTitle">
  <div class="container">
    ...
    <!-- タイトル -->
    <div class="singleTitle__heading noSp">
    ...
    <?php fit_breadcrumb(); ?>
      ...
      <!-- アイキャッチメイン -->
      <div class="single_eyecatch noPc">
        <div class="eyecatch">
        <?php if(has_post_thumbnail()) : ?>
          <?php if($myAmp){echo '<amp-img layout="responsive"';}else{echo '<img';} ?> src="<?php echo $src; ?>" alt="<?php the_title(); ?>" width="<?php echo $width; ?>" height="<?php echo $height; ?>" >
            <?php if($myAmp){echo '</amp-img>';}?>
        ...
        <!-- /アイキャッチ -->
        <!-- タイトル -->
        <div class="singleTitle__heading noPc">
          <h1 class="heading heading-singleTitle u-txtShdw"><?php the_title(); ?></h1>
            ...
            <div class="ctaPost">
              ...
              <div class="ctaPost__contents">
                ...
                <?php if (get_fit_cta_postImg()) :
                  ...
                  $postImg_full = wp_get_attachment_image_src( $postImg_id, 'large' );
              ...
              <aside class="profile">
                <div class="profile__imgArea">
                  ...
                  <div class="profile__contents">
                    <h2 class="profile__name">かいたひと：<?php the_author_meta('display_name'); ?>
